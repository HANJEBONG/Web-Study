...
<body>
  <div class="container">
    <div class="row">
      <form method="post" action="food_find2.jsp">
    ...
    <div class="row">
      <div class="text-center">
        <a href="food_find2.jsp?addr=<%=addr %>&page=<%= curpage>1? curpage-1:curpage %>" class="btn btn-sm btn-primary">이전</a>
        <%=curpage %> page / <%=totalpage %> pages
        <a href="food_find2.jsp?addr=<%=addr %>&page=<%= curpage<totalpage?curpage+1:curpage %>" class="btn btn-sm btn-primary">다음</a>
      </div>
    </div>
  </div>
</body>
